...
本教程面向希望系统学习智能体开发的读者，本来是我的一个书院探索项目为学生准备的一个学习材料，同时一边准备一边自己也学习，内容从智能体基础概念逐步推进到最小实现与工程实践，后来发现也可以作为自学材料、课程参考资料或教学配套讲义使用。智能的发展速度实在太快，很多材料准备有些仓促，也是一边准备一边完善提高，如有问题欢迎大家多提意见和建议。
