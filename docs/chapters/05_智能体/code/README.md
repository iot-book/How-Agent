...
python examples/teaching_minimal_demo.py
python examples/teaching_react_demo.py
python examples/teaching_plan_execute_demo.py
python examples/teaching_skills_demo.py
python examples/teaching_mcp_demo.py
python examples/teaching_full_capabilities_demo.py
```
